...
import { 
  ChevronRight, Edit3, MessageCircle, Globe, ChevronDown, 
  User, Bell, Shield, LogOut, Trash2 
} from "lucide-react";
import { APP_ASSETS, ASSETS } from "@/data/assets";
import { NotifToggle } from "@/components/market/NotifToggle";
import { TrendingUp, Heart, MessageCircle as MessageCircleIcon } from "lucide-react";
          ...
          <motion.div key="profile-notif" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            ...
            <div className="space-y-2 mb-8">
              {[
                ...
                { icon: <MessageCircleIcon className="w-4 h-4" />, color: "bg-[var(--mp-cyan)] text-background", user: "@WhaleWatch", action: language === "Turkish" ? "yorumuna yanıt verdi" : "replied to your comment", asset: "ETH", time: "15m" },
